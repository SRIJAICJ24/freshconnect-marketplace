...
def create_app(config_name=None):
    ...
    with app.app_context():
        from app.routes import main, auth, vendor, retailer, driver, admin, api, payment, barcode, emergency, vendor_barcode, admin_inventory, order_tracking, reviews, reports, notifications, vision, voice
